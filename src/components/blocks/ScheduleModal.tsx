      ...
      <div className="w-full max-w-md mx-4 rounded-2xl p-6"
        ...
        <div className="flex items-center justify-between mb-5">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-bold text-lg" style={{ color: 'var(--color-text-primary)' }}>排程設定</h2>
          </div>
        ...
        <p className="text-sm mb-4" style={{ color: 'var(--color-text-secondary)' }}>
          設定區塊「{block.title || '未命名'}」的顯示時間範圍。在此範圍外，區塊將自動隱藏。
        </p>

        <div className="flex flex-col gap-4">
          <label className="flex flex-col gap-1">
            <span className="text-sm font-semibold" style={{ color: 'var(--color-text-primary)' }}>開始時間</span>
          ...
          <label className="flex flex-col gap-1">
            <span className="text-sm font-semibold" style={{ color: 'var(--color-text-primary)' }}>結束時間</span>
